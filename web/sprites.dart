...
//  Shader shader;
  ...
  void insertSprite(double br, Vector3 p, SpriteTemplateRot str) {
    ...
    vertexData.setAll(spriteCount * FLOATS_PER_VERTEX * 4, [p.x, p.y, p.z, 0.0, str.xOffs0, str.yOffs0, str.u0, str.v0, br, p.x, p.y, p.z, 0.0, str.xOffs1, str.yOffs0, str.u1, str.v0, br, p.x, p.y, p.z, 0.0, str.xOffs1, str.yOffs1, str.u1, str.v1, br, p.x, p.y, p.z, 0.0, str.xOffs0, str.yOffs1, str.u0, str.v1, br,]);
  ...
  void insertGuiSprite(int x, int y, int z, Image image) {
    ...
    vertexData.setAll(spriteCount * FLOATS_PER_VERTEX * 4, [px, py, pz, 0.0, xOffs0, yOffs0, u0, v0, br, px, py, pz, 0.0, xOffs1, yOffs0, u1, v0, br, px, py, pz, 0.0, xOffs1, yOffs1, u1, v1, br, px, py, pz, 0.0, xOffs0, yOffs1, u0, v1, br,]);
...
class SpriteTemplateFrame {
  ...
  void setRot(int rot, Image image, bool mirror) {
    if (rot == 0) {
      if (rots == null) rots = new List<SpriteTemplateRot>(1); else if (rots.length != 1) throw "Tried to insert a 0 rot in a SpriteTemplateFrame";
      rots[0] = new SpriteTemplateRot(image, false);
    } else {
      if (rots == null) rots = new List<SpriteTemplateRot>(8); else if (rots.length != 8) throw "Tried to insert too many rots in a SpriteTemplateFrame";
...
class ScreenRenderer {
  ...
  void render() {
    ...
    vertexData.setAll(0, [0.0, 0.0, 0.0, v, 0.0, h, 0.0, 0.0, w, h, u, 0.0, w, 0.0, u, v,]);
...
class SkyRenderer {
  ...
  void render() {
    ...
    double v = 200 / 128;
    vertexData.setAll(0, [0.0, 0.0, -u, 0.0, uo, 0.0, h, -u, v, uo, w, h, u, v, uo, w, 0.0, u, 0.0, uo,]);
    gl.bufferSubDataTyped(GL.ARRAY_BUFFER, 0, vertexData);
