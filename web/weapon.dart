...
class Weapon {
  ...
  void renderAt(int x, int y) {
    if (animation == null) renderers.addGuiSprite(x, y, defaultSprite); else animation.render(x, y, animationTime);
  }
    ...
    for (int i = 0; i < amount; i++) {
      ...
      if (result != null) {
        ...
        if (result.entity != null) {
          ...
          if (result.entity.bleeds) level.entities.add(new Blood("BLUD", "ABC", level, result.pos, 0.0)); else level.entities.add(new Puff("PUFF", "ABCD", level, result.pos, 0.0));
        } else {
...
class Fists extends Weapon {
  static GunAnimation reloadAnimation = new GunAnimation([new GunAnimationFrame(2, ["PUNGB0"]), new GunAnimationFrame(2, ["PUNGC0"]), new GunAnimationFrame(2, ["PUNGD0"]), new GunAnimationFrame(3, ["PUNGC0"]), new GunAnimationFrame(4, ["PUNGB0"]),]);
...
class Chainsaw extends Weapon {
  static GunAnimation reloadAnimation = new GunAnimation([new GunAnimationFrame(2, ["SAWGA0"]), new GunAnimationFrame(2, ["SAWGB0"]),]);
...
class Pistol extends Weapon {
  static GunAnimation reloadAnimation = new GunAnimation([new GunAnimationFrame(4, ["PISGB0", "PISFA0"]), new GunAnimationFrame(4, ["PISGC0"]), new GunAnimationFrame(4, ["PISGB0"]), new GunAnimationFrame(3, ["PISGA0"]),]);
...
class Shotgun extends Weapon {
  static GunAnimation reloadAnimation = new GunAnimation([new GunAnimationFrame(3, ["SHTGA0", "SHTFA0"]), new GunAnimationFrame(3, ["SHTGA0", "SHTFB0"]), new GunAnimationFrame(3, ["SHTGB0"]), new GunAnimationFrame(8, ["SHTGC0"]), new GunAnimationFrame(8, ["SHTGD0"]), new GunAnimationFrame(4, ["SHTGC0"]), new GunAnimationFrame(4, ["SHTGB0"]), new GunAnimationFrame(4, ["SHTGA0"]),]);
...
class Chaingun extends Weapon {
  static GunAnimation fireAnimation1 = new GunAnimation([new GunAnimationFrame(3, ["CHGGA0", "CHGFA0"]),]);
  static GunAnimation fireAnimation2 = new GunAnimation([new GunAnimationFrame(3, ["CHGGB0", "CHGFB0"]),]);
...
class RocketLauncher extends Weapon {
  static GunAnimation reloadAnimation = new GunAnimation([new GunAnimationFrame(4, ["MISGA0", "MISFA0"]), new GunAnimationFrame(4, ["MISGB0", "MISFB0"]), new GunAnimationFrame(4, ["MISGB0", "MISFC0"]), new GunAnimationFrame(4, ["MISGB0", "MISFD0"]), new GunAnimationFrame(4, ["MISGA0"]),]);
...
class Plasmagun extends Weapon {
  static GunAnimation fireAnimation = new GunAnimation([new GunAnimationFrame(1, ["PLSFA0"]), new GunAnimationFrame(2, ["PLSFB0"]),]);

  static GunAnimation reloadAnimation = new GunAnimation([new GunAnimationFrame(16, ["PLSGB0"]),]);
...
class BFG extends Weapon {
  static GunAnimation reloadAnimation = new GunAnimation([new GunAnimationFrame(20, ["BFGGA0"]), new GunAnimationFrame(8, ["BFGGB0", "BFGFA0"]), new GunAnimationFrame(4, ["BFGGB0", "BFGFB0"]), new GunAnimationFrame(12, ["BFGGB0"]),]);
