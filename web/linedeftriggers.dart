...
class LinedefTriggers {
  ...
  LinedefTriggers() {
    // Local doors
    triggers[1] = new LocalDoorTrigger(DOOR_OPEN_CLOSE, SPEED_MED)
        ..activatedBy(TOUCH)
        ..setMonsterActivatable();
    triggers[26] = new LocalDoorTrigger(DOOR_OPEN_CLOSE, SPEED_MED)
        ..requireKey(KEY_BLUE)
        ..activatedBy(TOUCH);
    triggers[28] = new LocalDoorTrigger(DOOR_OPEN_CLOSE, SPEED_MED)
        ..requireKey(KEY_RED)
        ..activatedBy(TOUCH);
    triggers[27] = new LocalDoorTrigger(DOOR_OPEN_CLOSE, SPEED_MED)
        ..requireKey(KEY_YELLOW)
        ..activatedBy(TOUCH);

    triggers[31] = new LocalDoorTrigger(DOOR_OPEN, SPEED_MED)
        ..activatedBy(TOUCH)
        ..setOnce();
    triggers[32] = new LocalDoorTrigger(DOOR_OPEN, SPEED_MED)
        ..requireKey(KEY_BLUE)
        ..activatedBy(TOUCH)
        ..setOnce();
    triggers[33] = new LocalDoorTrigger(DOOR_OPEN, SPEED_MED)
        ..requireKey(KEY_RED)
        ..activatedBy(TOUCH)
        ..setOnce();
    triggers[34] = new LocalDoorTrigger(DOOR_OPEN, SPEED_MED)
        ..requireKey(KEY_YELLOW)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    triggers[118] = new LocalDoorTrigger(DOOR_OPEN, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..setOnce();

    // Remote doors
    triggers[4] = new DoorTrigger(DOOR_OPEN_CLOSE, SPEED_MED)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[29] = new DoorTrigger(DOOR_OPEN_CLOSE, SPEED_MED)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    triggers[2] = new DoorTrigger(DOOR_OPEN, SPEED_MED)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[103] = new DoorTrigger(DOOR_OPEN, SPEED_MED)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    triggers[3] = new DoorTrigger(DOOR_CLOSE, SPEED_MED)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[50] = new DoorTrigger(DOOR_CLOSE, SPEED_MED)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    triggers[16] = new DoorTrigger(DOOR_CLOSE_OPEN, SPEED_MED)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[76] = new DoorTrigger(DOOR_CLOSE_OPEN, SPEED_MED)..activatedBy(WALK);

    triggers[108] = new DoorTrigger(DOOR_OPEN_CLOSE, SPEED_TURBO)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[111] = new DoorTrigger(DOOR_OPEN_CLOSE, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    triggers[109] = new DoorTrigger(DOOR_OPEN, SPEED_TURBO)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[112] = new DoorTrigger(DOOR_OPEN, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    triggers[110] = new DoorTrigger(DOOR_CLOSE, SPEED_TURBO)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[113] = new DoorTrigger(DOOR_CLOSE, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    triggers[133] = new DoorTrigger(DOOR_OPEN, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..setOnce()
        ..requireKey(KEY_BLUE);
    triggers[99] = new DoorTrigger(DOOR_OPEN, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..requireKey(KEY_BLUE);
    triggers[135] = new DoorTrigger(DOOR_OPEN, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..setOnce()
        ..requireKey(KEY_RED);
    triggers[134] = new DoorTrigger(DOOR_OPEN, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..requireKey(KEY_RED);
    triggers[137] = new DoorTrigger(DOOR_OPEN, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..setOnce()
        ..requireKey(KEY_YELLOW);
    triggers[136] = new DoorTrigger(DOOR_OPEN, SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..requireKey(KEY_YELLOW);


    // Ceilings
    triggers[40] = new CeilingRaiseTrigger()
        ..activatedBy(WALK)
        ..setOnce();
    triggers[41] = new CeilingLowerTrigger(0.0)
        ..activatedBy(TOUCH)
        ..setOnce();
    triggers[43] = new CeilingLowerTrigger(0.0)..activatedBy(TOUCH);
    triggers[44] = new CeilingLowerTrigger(8.0)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[49] = new CeilingLowerTrigger(8.0)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    // Lifts
    triggers[10] = new LiftTrigger(SPEED_FAST)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[21] = new LiftTrigger(SPEED_FAST)
        ..activatedBy(TOUCH)
        ..setOnce();
    triggers[88] = new LiftTrigger(SPEED_FAST)
        ..activatedBy(WALK)
        ..setMonsterActivatable();
    triggers[62] = new LiftTrigger(SPEED_FAST)..activatedBy(TOUCH);
    triggers[121] = new LiftTrigger(SPEED_TURBO)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[122] = new LiftTrigger(SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    // Floors
    triggers[119] = new FloorRaiseNextHigherTrigger(SPEED_SLOW)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[128] = new FloorRaiseNextHigherTrigger(SPEED_SLOW)..activatedBy(WALK);
    triggers[18] = new FloorRaiseNextHigherTrigger(SPEED_SLOW)
        ..activatedBy(TOUCH)
        ..setOnce();
    triggers[69] = new FloorRaiseNextHigherTrigger(SPEED_SLOW)..activatedBy(TOUCH);

    triggers[22] = new FloorRaiseNextHigherTrigger(SPEED_SLOW)
        ..activatedBy(WALK)
        ..setOnce()
        ..setTransferProperties()
        ..setSectorUntriggerable();
    triggers[95] = new FloorRaiseNextHigherTrigger(SPEED_SLOW)
        ..activatedBy(WALK)
        ..setTransferProperties()
        ..setSectorUntriggerable();
    triggers[20] = new FloorRaiseNextHigherTrigger(SPEED_SLOW)
        ..activatedBy(TOUCH)
        ..setOnce()
        ..setTransferProperties()
        ..setSectorUntriggerable();
    triggers[68] = new FloorRaiseNextHigherTrigger(SPEED_SLOW)
        ..activatedBy(TOUCH)
        ..setTransferProperties()
        ..setSectorUntriggerable();
    triggers[47] = new FloorRaiseNextHigherTrigger(SPEED_SLOW)
        ..activatedBy(BULLET)
        ..setOnce()
        ..setTransferProperties()
        ..setSectorUntriggerable();

    triggers[5] = new FloorRaiseLowestCeilingTrigger(SPEED_SLOW, 0.0)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[91] = new FloorRaiseLowestCeilingTrigger(SPEED_SLOW, 0.0)..activatedBy(WALK);
    triggers[101] = new FloorRaiseLowestCeilingTrigger(SPEED_SLOW, 0.0)
        ..activatedBy(TOUCH)
        ..setOnce();
    triggers[64] = new FloorRaiseLowestCeilingTrigger(SPEED_SLOW, 0.0)..activatedBy(TOUCH);
    triggers[24] = new FloorRaiseLowestCeilingTrigger(SPEED_SLOW, 0.0)
        ..activatedBy(BULLET)
        ..setOnce();

    triggers[130] = new FloorRaiseNextHigherTrigger(SPEED_TURBO)
        ..activatedBy(WALK)
        ..setOnce();
    triggers[131] = new FloorRaiseNextHigherTrigger(SPEED_TURBO)
        ..activatedBy(TOUCH)
        ..setOnce();
    ...
    triggers[56] = new FloorRaiseLowestCeilingTrigger(SPEED_SLOW, 8.0)
        ..activatedBy(WALK)
        ..setOnce()
        ..setSectorUntriggerable()
        ..setCrush();
    triggers[94] = new FloorRaiseLowestCeilingTrigger(SPEED_SLOW, 8.0)
        ..activatedBy(WALK)
        ..setSectorUntriggerable()
        ..setCrush();
    triggers[55] = new FloorRaiseLowestCeilingTrigger(SPEED_SLOW, 8.0)
        ..activatedBy(TOUCH)
        ..setOnce()
        ..setCrush();
    triggers[65] = new FloorRaiseLowestCeilingTrigger(SPEED_SLOW, 8.0)
        ..activatedBy(TOUCH)
        ..setCrush();
  }
}
...
class LiftEffect extends SectorEffect {
  ...
  bool lower(double passedTime) {
    ...
    for (int i = 0; i < sector.neighborSectors.length; i++) {
      if (sector.neighborSectors[i].floorHeight < lowestNeighborFloor) lowestNeighborFloor = sector.neighborSectors[i].floorHeight;
    }
...
class CeilingRaiseEffect extends SectorEffect {
  ...
  void tick(double passedTime) {
    ...
    for (int i = 0; i < sector.neighborSectors.length; i++) {
      if (sector.neighborSectors[i].ceilingHeight > highestNeighborCeiling) highestNeighborCeiling = sector.neighborSectors[i].ceilingHeight;
    }
...
class DoorEffect extends SectorEffect {
  ...
  bool openDoor(double passedTime) {
    ...
    for (int i = 0; i < sector.neighborSectors.length; i++) {
      if (sector.neighborSectors[i].ceilingHeight < lowestNeighborCeiling) lowestNeighborCeiling = sector.neighborSectors[i].ceilingHeight;
    }
...
class DoorOpenCloseEffect extends DoorEffect {
  ...
  void replaceWithEffect(SectorEffect effect) {
    if (effect is DoorOpenCloseEffect) {
      if (phase != 2) phase = 2; else phase = 0;
    } else {
