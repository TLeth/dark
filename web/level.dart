...
class Level {
  ...
  void loadThing(WAD.Thing thing) {
    ...
    switch (thing.type) {
      case 0x0001:
        playerSpawns[0] = new PlayerSpawn(spritePos, rot);
        break; // Spawn 1
      case 0x0002:
        playerSpawns[1] = new PlayerSpawn(spritePos, rot);
        break; // Spawn 2
      case 0x0003:
        playerSpawns[2] = new PlayerSpawn(spritePos, rot);
        break; // Spawn 3
      case 0x0004:
        playerSpawns[3] = new PlayerSpawn(spritePos, rot);
        break; // Spawn 4
      case 0x000b:
        deathmatchSpawns.add(new PlayerSpawn(spritePos, rot));
        break; // Multiplayer spawn
      case 0x0bbc:
        entities.add(new Monster("POSS", this, spritePos, rot));
        break; // Former Human
      case 0x0054:
        entities.add(new Monster("SSWV", this, spritePos, rot));
        break; // Wolfenstein SS
      case 0x0009:
        entities.add(new Monster("SPOS", this, spritePos, rot));
        break; // Former Human Seargeant
      case 0x0041:
        entities.add(new Monster("CPOS", this, spritePos, rot));
        break; // Heavy Weapon Dude
      case 0x0bb9:
        entities.add(new Monster("TROO", this, spritePos, rot));
        break; // Imp
      case 0x0bba:
        entities.add(new Monster("SARG", this, spritePos, rot));
        break; // Demon
      case 0x003a:
        entities.add(new Monster("SARG", this, spritePos, rot, true));
        break; // Spectre
      case 0x0bbe:
        entities.add(new Monster("SKUL", this, spritePos, rot));
        break; // Lost soul
      case 0x0bbd:
        entities.add(new Monster("HEAD", this, spritePos, rot));
        break; // Cacodemon
      case 0x0045:
        entities.add(new Monster("BOS2", this, spritePos, rot));
        break; // Hell Knight
      case 0x0bbb:
        entities.add(new Monster("BOSS", this, spritePos, rot));
        break; // Baron of Hell
      case 0x0044:
        entities.add(new Monster("BSPI", this, spritePos, rot));
        break; // Arachnotron
      case 0x0047:
        entities.add(new Monster("PAIN", this, spritePos, rot));
        break; // Pain elemental
      case 0x0042:
        entities.add(new Monster("SKEL", this, spritePos, rot));
        break; // Revenant
      case 0x0043:
        entities.add(new Monster("FATT", this, spritePos, rot));
        break; // Mancubus
      case 0x0040:
        entities.add(new Monster("VILE", this, spritePos, rot));
        break; // Arch-vile
      case 0x0007:
        entities.add(new Monster("SPID", this, spritePos, rot));
        break; // Spider Mastermind
      case 0x0010:
        entities.add(new Monster("CYBR", this, spritePos, rot));
        break; // Cyber-demon
      case 0x0058:
        entities.add(new Monster("BBRN", this, spritePos, rot));
        break; // Romero

      case 0x07d5:
        entities.add(new Pickup("CSAW", "a", this, spritePos, rot));
        break; //     $ Chainsaw
      case 0x07d1:
        entities.add(new Pickup("SHOT", "a", this, spritePos, rot));
        break; //      $ Shotgun
      case 0x0052:
        entities.add(new Pickup("SGN2", "a", this, spritePos, rot));
        break; //      $ Double-barreled shotgun
      case 0x07d2:
        entities.add(new Pickup("MGUN", "a", this, spritePos, rot));
        break; //      $ Chaingun, gatling gun, mini-gun, whatever
      case 0x07d3:
        entities.add(new Pickup("LAUN", "a", this, spritePos, rot));
        break; //      $ Rocket launcher
      case 0x07d4:
        entities.add(new Pickup("PLAS", "a", this, spritePos, rot));
        break; //      $ Plasma gun
      case 0x07d6:
        entities.add(new Pickup("BFUG", "a", this, spritePos, rot));
        break; //      $ Bfg9000
      case 0x07d7:
        entities.add(new Pickup("CLIP", "a", this, spritePos, rot));
        break; //      $ Ammo clip
      case 0x07d8:
        entities.add(new Pickup("SHEL", "a", this, spritePos, rot));
        break; //      $ Shotgun shells
      case 0x07da:
        entities.add(new Pickup("ROCK", "a", this, spritePos, rot));
        break; //      $ A rocket
      case 0x07ff:
        entities.add(new Pickup("CELL", "a", this, spritePos, rot));
        break; //      $ Cell charge
      case 0x0800:
        entities.add(new Pickup("AMMO", "a", this, spritePos, rot));
        break; //      $ Box of Ammo
      case 0x0801:
        entities.add(new Pickup("SBOX", "a", this, spritePos, rot));
        break; //      $ Box of Shells
      case 0x07fe:
        entities.add(new Pickup("BROK", "a", this, spritePos, rot));
        break; //      $ Box of Rockets
      case 0x0011:
        entities.add(new Pickup("CELP", "a", this, spritePos, rot));
        break; //      $ Cell charge pack
      case 0x0008:
        entities.add(new Pickup("BPAK", "a", this, spritePos, rot));
        break; //      $ Backpack: doubles maximum ammo capacities
      case 0x07db:
        entities.add(new Pickup("STIM", "a", this, spritePos, rot));
        break; //      $ Stimpak
      case 0x07dc:
        entities.add(new Pickup("MEDI", "a", this, spritePos, rot));
        break; //      $ Medikit
      case 0x07de:
        entities.add(new Pickup("BON1", "abcdcb", this, spritePos, rot));
        break; // ! Health Potion +1% health
      case 0x07df:
        entities.add(new Pickup("BON2", "abcdcb", this, spritePos, rot));
        break; // ! Spirit Armor +1% armor
      case 0x07e2:
        entities.add(new Pickup("ARM1", "ab", this, spritePos, rot));
        break; //     $ Green armor 100%
      case 0x07e3:
        entities.add(new Pickup("ARM2", "ab", this, spritePos, rot));
        break; //     $ Blue armor 200%
      case 0x0053:
        entities.add(new Pickup("MEGA", "abcd", this, spritePos, rot));
        break; //   ! Megasphere: 200% health, 200% armor
      case 0x07dd:
        entities.add(new Pickup("SOUL", "abcdcb", this, spritePos, rot));
        break; // ! Soulsphere, Supercharge, +100% health
      case 0x07e6:
        entities.add(new Pickup("PINV", "abcd", this, spritePos, rot));
        break; //   ! Invulnerability
      case 0x07e7:
        entities.add(new Pickup("PSTR", "a", this, spritePos, rot));
        break; //      ! Berserk Strength and 100% health
      case 0x07e8:
        entities.add(new Pickup("PINS", "abcd", this, spritePos, rot));
        break; //   ! Invisibility
      case 0x07e9:
        entities.add(new Pickup("SUIT", "a", this, spritePos, rot));
        break; //     (!)Radiation suit - see notes on ! above
      case 0x07ea:
        entities.add(new Pickup("PMAP", "abcdcb", this, spritePos, rot));
        break; // ! Computer map
      case 0x07fd:
        entities.add(new Pickup("PVIS", "ab", this, spritePos, rot));
        break; //     ! Lite Amplification goggles
      case 0x0005:
        entities.add(new Pickup("BKEY", "ab", this, spritePos, rot));
        break; //     $ Blue keycard
      case 0x0028:
        entities.add(new Pickup("BSKU", "ab", this, spritePos, rot));
        break; //     $ Blue skullkey
      case 0x000d:
        entities.add(new Pickup("RKEY", "ab", this, spritePos, rot));
        break; //     $ Red keycard
      case 0x0026:
        entities.add(new Pickup("RSKU", "ab", this, spritePos, rot));
        break; //     $ Red skullkey
      case 0x0006:
        entities.add(new Pickup("YKEY", "ab", this, spritePos, rot));
        break; //     $ Yellow keycard
      case 0x0027:
        entities.add(new Pickup("YSKU", "ab", this, spritePos, rot));
        break; //     $ Yellow skullkey


      case 0x000a:
        entities.add(new Decoration("PLAY", "w", this, spritePos, rot));
        break; // Bloody mess (an exploded player)
      case 0x000c:
        entities.add(new Decoration("PLAY", "w", this, spritePos, rot));
        break;
      //
      case 0x0018:
        entities.add(new Decoration("POL5", "a", this, spritePos, rot));
        break; // Pool of blood and flesh
      case 0x004f:
        entities.add(new Decoration("POB1", "a", this, spritePos, rot));
        break; // Pool of blood
      case 0x0050:
        entities.add(new Decoration("POB2", "a", this, spritePos, rot));
        break; // Pool of blood
      case 0x0051:
        entities.add(new Decoration("BRS1", "a", this, spritePos, rot));
        break; // Pool of brains
      case 0x000f:
        entities.add(new Decoration("PLAY", "n", this, spritePos, rot));
        break; // Dead player
      case 0x0012:
        entities.add(new Decoration("POSS", "l", this, spritePos, rot));
        break; // Dead former human
      case 0x0013:
        entities.add(new Decoration("SPOS", "l", this, spritePos, rot));
        break; // Dead former sergeant
      case 0x0014:
        entities.add(new Decoration("TROO", "m", this, spritePos, rot));
        break; // Dead imp
      case 0x0015:
        entities.add(new Decoration("SARG", "n", this, spritePos, rot));
        break; // Dead demon
      case 0x0016:
        entities.add(new Decoration("HEAD", "l", this, spritePos, rot));
        break; // Dead cacodemon
      case 0x0017:
        entities.add(new Decoration("SKUL", "k", this, spritePos, rot));
        break; // Dead lost soul, invisible

      case 0x0030:
        entities.add(new Decoration.blocking("ELEC", "a", this, spritePos, rot));
        break; //      # Tall, techno pillar
      case 0x001e:
        entities.add(new Decoration.blocking("COL1", "a", this, spritePos, rot));
        break; //      # Tall green pillar
      case 0x0020:
        entities.add(new Decoration.blocking("COL3", "a", this, spritePos, rot));
        break; //      # Tall red pillar
      case 0x001f:
        entities.add(new Decoration.blocking("COL2", "a", this, spritePos, rot));
        break; //      # Short green pillar
      case 0x0024:
        entities.add(new Decoration.blocking("COL5", "ab", this, spritePos, rot));
        break; //     # Short green pillar with beating heart
      case 0x0021:
        entities.add(new Decoration.blocking("COL4", "a", this, spritePos, rot));
        break; //      # Short red pillar
      case 0x0025:
        entities.add(new Decoration.blocking("COL6", "a", this, spritePos, rot));
        break; //      # Short red pillar with skull
      case 0x002f:
        entities.add(new Decoration.blocking("SMIT", "a", this, spritePos, rot));
        break; //      # Stalagmite: small brown pointy stump
      case 0x002b:
        entities.add(new Decoration.blocking("TRE1", "a", this, spritePos, rot));
        break; //      # Burnt tree: gray tree
      case 0x0036:
        entities.add(new Decoration.blocking("TRE2", "a", this, spritePos, rot));
        break; //      # Large brown tree
      case 0x07ec:
        entities.add(new Decoration.blocking("COLU", "a", this, spritePos, rot));
        break; //      # Floor lamp
      case 0x0055:
        entities.add(new Decoration.blocking("TLMP", "abcd", this, spritePos, rot));
        break; //   # Tall techno floor lamp
      case 0x0056:
        entities.add(new Decoration.blocking("TLP2", "abcd", this, spritePos, rot));
        break; //   # Short techno floor lamp
      case 0x0022:
        entities.add(new Decoration.blocking("CAND", "a", this, spritePos, rot));
        break; //        Candle
      case 0x0023:
        entities.add(new Decoration.blocking("CBRA", "a", this, spritePos, rot));
        break; //      # Candelabra
      case 0x002c:
        entities.add(new Decoration.blocking("TBLU", "abcd", this, spritePos, rot));
        break; //   # Tall blue firestick
      case 0x002d:
        entities.add(new Decoration.blocking("TGRE", "abcd", this, spritePos, rot));
        break; //   # Tall green firestick
      case 0x002e:
        entities.add(new Decoration.blocking("TRED", "abcd", this, spritePos, rot));
        break; //   # Tall red firestick
      case 0x0037:
        entities.add(new Decoration.blocking("SMBT", "abcd", this, spritePos, rot));
        break; //   # Short blue firestick
      case 0x0038:
        entities.add(new Decoration.blocking("SMGT", "abcd", this, spritePos, rot));
        break; //   # Short green firestick
      case 0x0039:
        entities.add(new Decoration.blocking("SMRT", "abcd", this, spritePos, rot));
        break; //   # Short red firestick
      case 0x0046:
        entities.add(new Decoration.blocking("FCAN", "abc", this, spritePos, rot));
        break; //    # Burning barrel
      case 0x0029:
        entities.add(new Decoration.blocking("CEYE", "abcb", this, spritePos, rot));
        break; //   # Evil Eye: floating eye in symbol, over candle
      case 0x002a:
        entities.add(new Decoration.blocking("FSKU", "abc", this, spritePos, rot));
        break; //    # Floating Skull: flaming skull-rock
      case 0x0031:
        entities.add(new Decoration.blocking("GOR1", "abcb", this, spritePos, rot)..hanging = true);
        break; //  ^# Hanging victim, twitching
      case 0x003f:
        entities.add(new Decoration.blocking("GOR1", "abcb", this, spritePos, rot)..hanging = true);
        break; //  ^  Hanging victim, twitching
      case 0x0032:
        entities.add(new Decoration.blocking("GOR2", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging victim, arms out
      case 0x003b:
        entities.add(new Decoration.blocking("GOR2", "a", this, spritePos, rot)..hanging = true);
        break; //     ^  Hanging victim, arms out
      case 0x0034:
        entities.add(new Decoration.blocking("GOR4", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging pair of legs
      case 0x003c:
        entities.add(new Decoration.blocking("GOR4", "a", this, spritePos, rot)..hanging = true);
        break; //     ^  Hanging pair of legs
      case 0x0033:
        entities.add(new Decoration.blocking("GOR3", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging victim, 1-legged
      case 0x003d:
        entities.add(new Decoration.blocking("GOR3", "a", this, spritePos, rot)..hanging = true);
        break; //     ^  Hanging victim, 1-legged
      case 0x0035:
        entities.add(new Decoration.blocking("GOR5", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging leg
      case 0x003e:
        entities.add(new Decoration.blocking("GOR5", "a", this, spritePos, rot)..hanging = true);
        break; //     ^  Hanging leg
      case 0x0049:
        entities.add(new Decoration.blocking("HDB1", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging victim, guts removed
      case 0x004a:
        entities.add(new Decoration.blocking("HDB2", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging victim, guts and brain removed
      case 0x004b:
        entities.add(new Decoration.blocking("HDB3", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging torso, looking down
      case 0x004c:
        entities.add(new Decoration.blocking("HDB4", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging torso, open skull
      case 0x004d:
        entities.add(new Decoration.blocking("HDB5", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging torso, looking up
      case 0x004e:
        entities.add(new Decoration.blocking("HDB6", "a", this, spritePos, rot)..hanging = true);
        break; //     ^# Hanging torso, brain removed
      case 0x0019:
        entities.add(new Decoration.blocking("POL1", "a", this, spritePos, rot));
        break; //      # Impaled human
      case 0x001a:
        entities.add(new Decoration.blocking("POL6", "ab", this, spritePos, rot));
        break; //     # Twitching impaled human
      case 0x001b:
        entities.add(new Decoration.blocking("POL4", "a", this, spritePos, rot));
        break; //      # Skull on a pole
      case 0x001c:
        entities.add(new Decoration.blocking("POL2", "a", this, spritePos, rot));
        break; //      # 5 skulls shish kebob
      case 0x001d:
        entities.add(new Decoration.blocking("POL3", "ab", this, spritePos, rot));
        break; //     # Pile of skulls and candles
